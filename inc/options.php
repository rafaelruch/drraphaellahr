		...
		acf_add_local_field_group(
			array(
				...
				'fields'                => array(
					...
					array(
						'key'     => 'field_lahr_cfg_hero_bg_msg',
						'label'   => 'Fundo da Hero (mídia única)',
						'type'    => 'message',
						'message' => 'Esta é a mídia de fundo da hero — trocada aqui, em um único lugar (não em cada banner). Os <strong>textos</strong> passam por cima como slides, editados no menu “Banners (Hero)”.',
					),
					lahr_f_select( 'field_lahr_cfg_hero_bg_tipo', 'hero_bg_tipo', 'Tipo de mídia de fundo', array( 'video' => 'Vídeo', 'foto' => 'Foto' ), 'video' ),
					lahr_f_image( 'field_lahr_cfg_hero_bg_imagem', 'hero_bg_imagem', 'Imagem de fundo (se Foto)' ),
					lahr_f_file( 'field_lahr_cfg_hero_bg_video', 'hero_bg_video', 'Vídeo de fundo — MP4', 'mp4', 'Formato MP4 (H.264). Recomendado para compatibilidade.' ),
					lahr_f_file( 'field_lahr_cfg_hero_bg_video_webm', 'hero_bg_video_webm', 'Vídeo de fundo — WebM (opcional)', 'webm', 'Versão WebM (menor). Opcional — melhora a performance quando presente.' ),
					lahr_f_image( 'field_lahr_cfg_hero_bg_poster', 'hero_bg_poster', 'Poster do vídeo (1º quadro)' ),
					lahr_f_true_false( 'field_lahr_cfg_hero_bg_contain', 'hero_bg_contain', 'Mostrar o vídeo inteiro (sem cortar)?', 1 ),
					array(
						'key'     => 'field_lahr_cfg_hero_beh_msg',
						'label'   => 'Comportamento do slider',
						'type'    => 'message',
						'message' => 'Controle de como os textos passam por cima do fundo.',
					),
